...
{toggle?
  <ul className="flex flex-col mt-8 bg-gray-300 p-2">
            <li className="p-3 transition-all east-in-out hover:scale-110 cursor-pointer">Home</li>
            <li className="p-3 transition-all east-in-out hover:scale-110 cursor-pointer">About Me</li>
            <li className="p-3 transition-all east-in-out hover:scale-110 cursor-pointer">Skills</li>
            <li className="p-3 transition-all east-in-out hover:scale-110 cursor-pointer">Portfolio</li>
            <li className="p-3 transition-all east-in-out hover:scale-110 cursor-pointer">Companies</li>
            <li className="p-3 transition-all east-in-out hover:scale-110 cursor-pointer">Contact Me</li>
          </ul>
          :
null}
        </div>
